...
{
    public sealed class HierarchyViewModeMaterialInfoViewHandler : IHierarchyViewModeHandler
    {
        public static readonly IHierarchyViewModeHandler Instance = new HierarchyViewModeMaterialInfoViewHandler();

        public HierarchyViewMode ViewMode => HierarchyViewMode.MaterialInfoView;
        ...
        {
            var text = GetMaterialInfoText(go);
        ...
        private static string GetMaterialInfoText(GameObject go)
        {
            if (go == null)
                return string.Empty;
